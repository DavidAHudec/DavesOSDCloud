...
Write-Host "1: Zero-Touch Win11 22H1 | English | Pro"-ForegroundColor Yellow
Write-Host "2: Zero-Touch Win11 22H2 | English | Pro" -ForegroundColor Yellow
...
switch ($input)
{
    '1' { Start-OSDCloud -OSLanguage en-us -OSVersion 'Windows 11' -OSBuild 22H1 -OSEdition Pro -ZTI } 
